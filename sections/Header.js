...
export default function Header() {
	...
	return (
		<header className="fixed top-0 left-0 z-50 w-full font-primary text-primary2 transition-colors duration-[850ms] ease-in-out">
			<div
				className={classNames(
					isOpen ? "translate-y-0" : "-translate-y-14",
					scrollPosition >= 50 && "bg-[#0f1922cc]",
					"absolute h-28 w-full backdrop-blur duration-[400ms] ease-in-out lg:-translate-y-14"
				)}
			/>
