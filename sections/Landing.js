...
export default function Landing() {
	return (
		<section className="relative flex h-screen w-full snap-start justify-center overflow-hidden bg-dashboard xl:items-center">
			<div className="relative mt-40 flex max-h-[60rem] w-[80%] max-w-7xl flex-col items-center justify-between text-primary2 sm:mt-60 xl:mt-32 xl:flex-row xl:items-start">
				...
				<div className="relative w-full max-w-xl">
					<SkateboardingScene className="relative z-[20] h-full w-full" />
				</div>
